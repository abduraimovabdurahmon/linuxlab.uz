...
# 🚀 KasmWeb O‘rnatish Qo‘llanmasi

## ❓ KasmWeb nima?

**KasmWeb** — bu Docker asosida ishlaydigan, veb-brauzer orqali ish stoli muhitlarini taqdim etuvchi platforma. U foydalanuvchilarga xavfsiz va qulay ish muhiti yaratish imkonini beradi.
...
## ⚡ Quick Start - KasmWebni tezkor o‘rnatish
<Callout type="info">
...
<Callout type={'info'} emoji={'🎉'}>Tabriklaymiz siz Ubuntu Focal ni docker bilan ishga tushirdingiz!</Callout>

![KasmWeb](/data/files/devops/docker/kasm/kasm-in-browser.png)

## 📦 Linuxserver Kasm'ni o'rnatish
...
```
Yoki uni buyerdan yuklab olishingiz mumkin: [docker-compose.yml](/data/files/devops/docker/kasm/docker-compose.yaml)
...
**Qolganini o'ziz bir amallarsiz 😁**